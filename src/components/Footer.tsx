        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-8">
          ...
          <div className="space-y-4">
            <div className="flex items-center space-x-2">
              ...
              <span className="font-bold text-lg">NaturalSoap Co.</span>
            </div>
            <p className="text-gray-300 text-sm leading-relaxed">
              Crafting premium handmade natural soaps with organic ingredients. 
              Started with soaps, expanding to more natural products for healthy, beautiful skin.
            </p>
          ...
          <div className="space-y-4">
            ...
            <ul className="space-y-2 text-sm">
              ...
              <li>
                <Link href="/shop?category=soaps" className="text-gray-300 hover:text-white transition-colors duration-200">
                  Natural Soaps
                </Link>
              </li>
              <li>
          ...
          <div className="space-y-4">
            ...
            <ul className="space-y-2 text-sm">
              ...
              <li>
                <Link href="/care-guide" className="text-gray-300 hover:text-white transition-colors duration-200">
                  Soap Care Guide
                </Link>
              </li>
              <li>
                <Link href="/wholesale" className="text-gray-300 hover:text-white transition-colors duration-200">
                  Wholesale Orders
                </Link>
              </li>
            </ul>
          ...
          <div className="space-y-4">
            ...
            <div className="space-y-3 text-sm">
              ...
              <div className="flex items-center space-x-3">
                ...
                <span className="text-gray-300">(555) 123-SOAP</span>
              </div>
              <div className="flex items-center space-x-3">
                <svg className="w-5 h-5 text-green-500 flex-shrink-0" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                  <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M3 8l7.89 4.26a2 2 0 002.22 0L21 8M5 19h14a2 2 0 002-2V7a2 2 0 00-2-2H5a2 2 0 00-2 2v10a2 2 0 002 2z" />
                </svg>
                <span className="text-gray-300">hello@naturalsoap.co</span>
              </div>
            </div>
          </div>
        </div>
        ...
        <div className="border-t border-gray-800 mt-8 pt-8">
          <div className="flex flex-col md:flex-row justify-between items-center space-y-4 md:space-y-0">
            <div className="text-sm text-gray-400">
              © {currentYear} NaturalSoap Co. All rights reserved.
            </div>
